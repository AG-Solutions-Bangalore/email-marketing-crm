...
const AddContact = () => {
  const [contact, setContact] = useState({
    ...
    contact_email: "",
    contact_address: "",
    contact_group: "", // Changed to a string instead of an array for single selection
    contact_state: "",
    contact_pincode: "",
  });
  ...
  const handleGroupChange = (event) => {
    ...
    setContact((prev) => ({
      ...prev,
      contact_group: value, // Set the selected group value directly
    }));
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <FormControl sx={{ width: "100%" }}>
              ...
              <Select
                ...
                id="demo-group-name"
                value={contact.contact_group} // Single value selection
                onChange={handleGroupChange} // Single group selection handler
                input={
                  <OutlinedInput
                    sx={{
                      width: "100%",
...
<FormLabel required> Group Name</FormLabel>
<Select
  labelId="demo-multiple-group-name-label"
  id="demo-multiple-group-name"
  multiple
  name="contact_group"
