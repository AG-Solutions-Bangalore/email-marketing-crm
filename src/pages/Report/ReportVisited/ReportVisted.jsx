...
const ReportVisted = () => {
  const [reportvisteddata, SetVistedData] = useState([]);
  const [isLoading, setIsLoading] = useState(false);

  const fetchReportVisitedData = async () => {
    setIsLoading(true);
    try {
      ...
      SetVistedData(response.data?.individualCompanies || []);
    } catch (error) {
